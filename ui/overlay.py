...
class Overlay:
    def __init__(self):
        ...
        self._root.geometry("260x140+40+40")
        ...
        ctk.CTkLabel(
            header, text=config.APP_NAME, font=("Segoe UI", 14, "bold"),
            text_color="#f0f0f0",
        ).pack(side="left")
        ctk.CTkButton(
            header, text="×", width=24, height=24, fg_color="transparent",
            hover_color="#3a3a3a", text_color="#aaaaaa", font=("Segoe UI", 14),
        ...
        self._dot = ctk.CTkLabel(
            status_row, text="●", font=("Segoe UI", 14),
            text_color=MODE_COLORS["GESTURE"],
        )
        self._dot.pack(side="left")
        self._status_label = ctk.CTkLabel(
            status_row, text="GESTURE MODE", font=("Segoe UI", 12, "bold"),
            text_color="#e0e0e0",
        )
        self._status_label.pack(side="left", padx=(6, 0))

        self._toggle_btn = ctk.CTkButton(
            self._card, text="Switch to Voice", height=36, corner_radius=10,
            font=("Segoe UI", 12, "bold"), fg_color="#3a3a3a",
            hover_color="#4a4a4a", command=self._on_toggle,
        )
        self._toggle_btn.pack(fill="x", padx=14, pady=(8, 14))
